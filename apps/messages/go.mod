module github.com/epiphytelabs/stash/apps/messages

go 1.19

require (
	github.com/cespare/reflex v0.3.1
	github.com/convox/stdapi v1.1.2
...
replace (
	...
	github.com/graph-gophers/graphql-go => github.com/ddollar/graphql-go v1.4.0-ddollar
)
